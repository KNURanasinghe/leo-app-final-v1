...
class LivePageState extends State<LivePage>
  ...
  final bool _showWelcomeMessage = true;
  ...
  ZegoUIKitPrebuiltLiveAudioRoomConfig get config {
    return (widget.isHost
      ...
      ..duration = ZegoLiveAudioRoomLiveDurationConfig(
        isVisible: false, // Set this to false to hide the duration section
      )
      ..seat = (getSeatConfig()
      ...
      ..bottomMenuBar = ZegoLiveAudioRoomBottomMenuBarConfig(
        ...
        hostExtendButtons: [
          ...
          Row(
            mainAxisAlignment:
                MainAxisAlignment.spaceBetween, // Changed to spaceEvenly
            mainAxisSize: MainAxisSize.min,
            children: [
              GestureDetector(
                onTap: () {
